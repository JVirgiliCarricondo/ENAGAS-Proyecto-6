...
<qgis version="3.0" styleCategories="AllStyleCategories">
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" band="1" type="singlebandpseudocolor"
      classificationMin="1.5500" classificationMax="2.2510" nodataColor="">
      <rasterTransparency/>
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0"
          minimumValue="1.5500" maximumValue="2.2510"
          classificationMode="1" labelPrecision="3">
          <item value="1.5500" color="#1a9850" label="Coste bajo"  alpha="255"/>
          <item value="1.9005" color="#ffffbf" label="Coste medio" alpha="255"/>
          <item value="2.2510" color="#d73027" label="Coste alto"  alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
