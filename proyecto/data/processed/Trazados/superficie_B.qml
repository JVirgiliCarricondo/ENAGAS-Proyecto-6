...
<qgis version="3.0" styleCategories="AllStyleCategories">
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" band="1" type="singlebandpseudocolor"
      classificationMin="1.0600" classificationMax="1.7310" nodataColor="">
      <rasterTransparency/>
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0"
          minimumValue="1.0600" maximumValue="1.7310"
          classificationMode="1" labelPrecision="3">
          <item value="1.0600"  color="#1a9850" label="Coste bajo"   alpha="255"/>
          <item value="1.3955" color="#ffffbf" label="Coste medio"  alpha="255"/>
          <item value="1.7310"  color="#d73027" label="Coste alto"   alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
